...
<!--================================  LLAMADOS DE LA VOZ ======================================-->
<input type="hidden" id="cname" value='<?= $_GET["cname"] ?>'>
<!--================================  LLAMADOS DE LA VOZ ======================================-->
  ...
  <!--================================ ESTOS SON LOS LLAMADOS DE LA VOZ ======================================-->
 <button hidden="" id="btn-speack" onclick="saludo();">Saludo</button>
   <!--================================ ESTOS SON LOS LLAMADOS DE LA VOZ ======================================-->
</main>
  ...
  <!--================================ ESTOS SON LOS LLAMADOS DE LA VOZ ======================================-->
	...
	$(document).ready(function(){
		...
		setTimeout("$('#btn-speack').trigger('click')",7000);
	...
	function saludo() {
		...
		var saludo = "Hola "+cname+",,,, hemos encontrado 3 resultados,,,,   seguros suramericana parece ser la mejor opci��n para ti ,,,, si te interesa alguno de los resultados haz clic en el boton solicitar,,,, ";
	...
	$("#filter-si").click(function(){
		window.location='question_1.php';
	});
